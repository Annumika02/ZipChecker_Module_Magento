...
namespace Inventionstar\ZipChecker\Model\Import;
use Inventionstar\ZipChecker\Model\Import\CustomImport\RowValidatorInterface as ValidatorInterface;
...
class CustomImport extends \Magento\ImportExport\Model\Import\Entity\AbstractEntity
{
    ...
    const TABLE_Entity = 'inventionstar_zip_checker';
    /**
    ...
    {
        return 'inventionstar_zip_checker';
    }
        ...
        if ($table && $listTitle) {
            try {
                $this->countItemsDeleted += $this->_connection->delete(
                    ...
                    $this->_connection->quoteInto('inventionstar_zip_checker IN (?)', $listTitle)
                );
                return true;
            } catch (\Exception $e) {
                return false;
